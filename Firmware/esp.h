...
#define ESP_ENABLE IOPORT_CREATE_PIN(PORTA, 6)
#define ESP_RESET IOPORT_CREATE_PIN(PORTA, 0)
#define ESP_GPIO_0 IOPORT_CREATE_PIN(PORTA, 4)
#define ESP_GPIO_2 IOPORT_CREATE_PIN(PORTA, 1)
